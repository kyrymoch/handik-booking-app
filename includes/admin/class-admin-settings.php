...
class Handik_Booking_App_Admin_Settings {
	...
	protected function render_booking_flow_tab( array $s ) {
		...
		<?php $this->section_open( __( 'Scheduling', 'handik-booking-app' ) ); ?>
			...
			<?php Handik_Booking_App_Admin_Helpers::field( 'mileage_rate_cents', __( 'IRS mileage rate (cents per mile)', 'handik-booking-app' ), $s['mileage_rate_cents'], 'number' ); ?>
			<p class="handik-admin-muted"><?php esc_html_e( 'Used by the Reports page for the mileage deduction. 2025 IRS standard rate is 70¢/mile.', 'handik-booking-app' ); ?></p>
		<?php $this->section_close(); ?>
		<?php
	}
