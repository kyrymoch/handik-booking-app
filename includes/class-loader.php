...
class Handik_Booking_App_Loader {
	public static function load() {
		$files = array(
			...
			'includes/db/migrations/class-migration-160.php',
			'includes/db/migrations/class-migration-161.php',
			'includes/db/migrations/class-migration-162.php',
			'includes/db/migrations/class-migration-163.php',
			'includes/db/migrations/class-migration-164.php',
			...
			'includes/services/class-customer-view-service.php',
			...
			'includes/services/class-ics-builder.php',
			'includes/services/class-notifications-service.php',
			...
			'includes/forms/class-form-approvals-service.php',
