...
class Handik_Booking_App_Settings {
	...
	protected $constant_map = array(
		...
		'cal_api_key'            => 'HANDIK_BOOKING_APP_CAL_API_KEY',
		'cal_api_base'           => 'HANDIK_BOOKING_APP_CAL_API_BASE',
		'cal_api_version'        => 'HANDIK_BOOKING_APP_CAL_API_VERSION',
		'cal_api_timezone'       => 'HANDIK_BOOKING_APP_CAL_API_TIMEZONE',
		'operator_first_name'    => 'HANDIK_BOOKING_APP_OPERATOR_FIRST_NAME',
	...
	public function defaults() {
		return array(
			...
			// Plan-B (assistant stuck) copy — fires on mount-failed / preparing-timeout.
