		...
		wp_localize_script(
			...
			array(
				...
				'strings'    => array(
					...
					'assistantIntro'     => (string) $this->settings->get( 'ui_assistant_intro', (string) $this->settings->get( 'ui_assistant_helper', 'This AI assistant can help estimate the job, time, materials, and next steps while collecting the details we need to prepare properly.' ) ),
					'assistantContinue'  => (string) $this->settings->get( 'ui_assistant_continue_button', 'Choose time' ),
