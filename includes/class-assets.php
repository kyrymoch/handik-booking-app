	...
	public function enqueue_frontend() {
		...
		wp_localize_script(
			...
			array(
				...
				'strings'    => array(
					'loading'            => __( 'Getting the toolbox ready...', 'handik-booking-app' ),
					'loadingSubtext'     => __( 'Waking up the booking wizard and bribing it with coffee.', 'handik-booking-app' ),
					...
					'assistantGreeting'  => __( 'Describe the task and I will help estimate time, materials, and the next step.', 'handik-booking-app' ),
					'assistantHelper'    => __( 'This is our virtual AI assistant, not a live person. Describe the task, ask questions about time or materials, or type a quick summary below and continue.', 'handik-booking-app' ),
					'assistantPlaceholder' => __( 'Example: install two curtain rods and fix a loose kitchen cabinet hinge.', 'handik-booking-app' ),
