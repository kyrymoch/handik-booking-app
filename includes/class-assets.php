	...
	public function enqueue_frontend() {
		...
		wp_localize_script(
			...
			array(
				...
				'strings'    => array(
					'loading'            => __( 'Getting your booking space ready...', 'handik-booking-app' ),
					'loadingSubtext'     => __( 'Laying out the tools and making room for the good stuff.', 'handik-booking-app' ),
					...
					'assistantHelper'    => __( 'This is Handik\'s virtual assistant. Tell it about the job, ask any questions about time or materials, then tap Continue when you are ready.', 'handik-booking-app' ),
