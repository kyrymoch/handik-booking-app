	...
	public function enqueue_frontend() {
		...
		wp_localize_script(
			...
			array(
				...
				'strings'    => array(
					'loading'            => (string) $this->settings->get( 'ui_loading_title', 'Getting your booking space ready...' ),
					'loadingSubtext'     => (string) $this->settings->get( 'ui_loading_subtitle', 'Laying out the tools and making room for the good stuff.' ),
					...
					'bookingCancelled'   => (string) $this->settings->get( 'ui_booking_cancelled', 'This booking was cancelled. You can book another slot below.' ),
					'addressPlaceholder' => (string) $this->settings->get( 'ui_address_placeholder', 'Start typing the address of the job' ),
					'loadingAssistant'   => (string) $this->settings->get( 'ui_loading_assistant_title', 'Loading virtual assistant...' ),
					'loadingAssistantSubtext' => (string) $this->settings->get( 'ui_loading_assistant_subtitle', 'Charging the tiny robot brain for your next step.' ),
					...
					'newClientTooltipText' => (string) $this->settings->get( 'ui_new_client_tooltip_text', 'Choose this if this is your first time booking with Handik or you have not used our booking flow before.' ),
					'returningClientTooltipTitle' => (string) $this->settings->get( 'ui_returning_client_tooltip_title', 'Returning client' ),
					'returningClientTooltipText' => (string) $this->settings->get( 'ui_returning_client_tooltip_text', 'Choose this if you have booked with Handik before and want to reuse your saved details.' ),
					...
					'photosIntro'        => (string) $this->settings->get( 'ui_photos_intro', 'Photos really help us understand the job faster, but you can skip this step if you do not have any.' ),
