		...
		wp_localize_script(
			...
			array(
				...
				'strings'    => array(
					...
					'addressHelp'        => (string) $this->settings->get( 'ui_address_help', 'Choose a suggested address from Google to continue.' ),
					'addressValidHelp'   => (string) $this->settings->get( 'ui_address_valid_help', 'Address verified.' ),
					...
					'assistantIntro'     => (string) $this->settings->get( 'ui_assistant_intro', 'Describe the task, ask any questions you have, and continue when you are ready to choose a time.' ),
